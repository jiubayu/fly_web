...
//     [P in K]: T;
// };
export declare type GenericValidateFunction = (
  value: any
...
> {
  ...
  schema?:
    | Record<
        keyof TValues,
        GenericValidateFunction | string | Record<string, any>
      >
  ...
  setErrors: (
    fields: Partial<Record<keyof TValues, string | undefined>>
  ) => void;
...
export declare type SubmissionContext<
  TValues extends Record<string, any> = Record<string, any>
> = {
  evt: SubmitEvent;
